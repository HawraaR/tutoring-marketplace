...
// Full application — every field required (arrays may be omitted)
...
export const tutorProfileUpdateSchema = z.object({
  ...
  subjects: z.array(z.string().trim().min(1)).min(1, "Add at least one subject").optional(),
...
// For the admin approve/reject step (used later)
